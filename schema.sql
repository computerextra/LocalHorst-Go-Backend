...
--
-- Host: localhost
-- Erstellungszeit: 12. Apr 2025 um 14:25
...
CREATE TABLE `Artikel` (
  ...
  `Suchbegriff` varchar(191) NOT NULL,
...
CREATE TABLE `Team` (
  `id` int(11) NOT NULL,
  `Mitarbeiter` varchar(191) NOT NULL,
  `Farbe` varchar(191) NOT NULL,
  `Ort` varchar(191) NOT NULL,
  `inventurJahr` varchar(191) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `Artikel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `Artikel_teamId_fkey` (`teamId`);
...
--
-- Indizes für die Tabelle `Inventur`
--
ALTER TABLE `Inventur`
  ADD PRIMARY KEY (`Jahr`),
  ADD UNIQUE KEY `Inventur_Jahr_key` (`Jahr`);
...
ALTER TABLE `Team`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `Team_id_key` (`id`),
  ADD KEY `Team_inventurJahr_fkey` (`inventurJahr`);
...
--
ALTER TABLE `Artikel`
  ADD CONSTRAINT `Artikel_teamId_fkey` FOREIGN KEY (`teamId`) REFERENCES `Team` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `Team`
  ADD CONSTRAINT `Team_inventurJahr_fkey` FOREIGN KEY (`inventurJahr`) REFERENCES `Inventur` (`Jahr`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
