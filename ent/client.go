...
// QueryMitarbeiter queries the mitarbeiter edge of a Mitarbeiter.
func (c *MitarbeiterClient) QueryMitarbeiter(m *Mitarbeiter) *UserQuery {
...
// QueryMitarbeiter queries the mitarbeiter edge of a User.
func (c *UserClient) QueryMitarbeiter(u *User) *MitarbeiterQuery {
