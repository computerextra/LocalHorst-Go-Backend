...
// HasAnsprechpartner applies the HasEdge predicate on the "Ansprechpartner" edge.
func HasAnsprechpartner() predicate.Lieferant {
...
// HasAnsprechpartnerWith applies the HasEdge predicate on the "Ansprechpartner" edge with a given conditions (other predicates).
func HasAnsprechpartnerWith(preds ...predicate.Ansprechpartner) predicate.Lieferant {
	return predicate.Lieferant(func(s *sql.Selector) {
		step := newAnsprechpartnerStep()
