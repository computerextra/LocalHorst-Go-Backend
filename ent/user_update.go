...
func (uu *UserUpdate) SetMitarbeiterID(id int) *UserUpdate {
	uu.mutation.SetMitarbeiterID(id)
	return uu
}

// SetNillableMitarbeiterID sets the "mitarbeiter" edge to the Mitarbeiter entity by ID if the given value is not nil.
func (uu *UserUpdate) SetNillableMitarbeiterID(id *int) *UserUpdate {
	if id != nil {
		uu = uu.SetMitarbeiterID(*id)
	}
	return uu
}

// SetMitarbeiter sets the "mitarbeiter" edge to the Mitarbeiter entity.
func (uu *UserUpdate) SetMitarbeiter(m *Mitarbeiter) *UserUpdate {
	return uu.SetMitarbeiterID(m.ID)
}
...
func (uu *UserUpdate) ClearMitarbeiter() *UserUpdate {
	uu.mutation.ClearMitarbeiter()
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.MitarbeiterCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   user.MitarbeiterTable,
			Columns: []string{user.MitarbeiterColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(mitarbeiter.FieldID, field.TypeInt),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := uu.mutation.MitarbeiterIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   user.MitarbeiterTable,
...
// SetMitarbeiterID sets the "mitarbeiter" edge to the Mitarbeiter entity by ID.
func (uuo *UserUpdateOne) SetMitarbeiterID(id int) *UserUpdateOne {
	uuo.mutation.SetMitarbeiterID(id)
	return uuo
}

// SetNillableMitarbeiterID sets the "mitarbeiter" edge to the Mitarbeiter entity by ID if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableMitarbeiterID(id *int) *UserUpdateOne {
	if id != nil {
		uuo = uuo.SetMitarbeiterID(*id)
	}
	return uuo
}

// SetMitarbeiter sets the "mitarbeiter" edge to the Mitarbeiter entity.
func (uuo *UserUpdateOne) SetMitarbeiter(m *Mitarbeiter) *UserUpdateOne {
	return uuo.SetMitarbeiterID(m.ID)
}
...
// ClearMitarbeiter clears the "mitarbeiter" edge to the Mitarbeiter entity.
func (uuo *UserUpdateOne) ClearMitarbeiter() *UserUpdateOne {
	uuo.mutation.ClearMitarbeiter()
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.MitarbeiterCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   user.MitarbeiterTable,
	...
	if nodes := uuo.mutation.MitarbeiterIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   user.MitarbeiterTable,
