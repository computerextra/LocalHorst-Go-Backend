...
func (vc *VersionCreate) SetCurrentVersion(f float64) *VersionCreate {
	vc.mutation.SetCurrentVersion(f)
	return vc
}
...
func (vc *VersionCreate) check() error {
	if _, ok := vc.mutation.CurrentVersion(); !ok {
		return &ValidationError{Name: "CurrentVersion", err: errors.New(`ent: missing required field "Version.CurrentVersion"`)}
	}
	return nil
}
...
// SetCurrentVersion sets the "CurrentVersion" field.
func (u *VersionUpsert) SetCurrentVersion(v float64) *VersionUpsert {
	u.Set(version.FieldCurrentVersion, v)
	return u
}

// UpdateCurrentVersion sets the "CurrentVersion" field to the value that was provided on create.
func (u *VersionUpsert) UpdateCurrentVersion() *VersionUpsert {
	u.SetExcluded(version.FieldCurrentVersion)
	return u
}

// AddCurrentVersion adds v to the "CurrentVersion" field.
func (u *VersionUpsert) AddCurrentVersion(v float64) *VersionUpsert {
...
// SetCurrentVersion sets the "CurrentVersion" field.
func (u *VersionUpsertOne) SetCurrentVersion(v float64) *VersionUpsertOne {
...
// AddCurrentVersion adds v to the "CurrentVersion" field.
func (u *VersionUpsertOne) AddCurrentVersion(v float64) *VersionUpsertOne {
	return u.Update(func(s *VersionUpsert) {
...
// SetCurrentVersion sets the "CurrentVersion" field.
func (u *VersionUpsertBulk) SetCurrentVersion(v float64) *VersionUpsertBulk {
	return u.Update(func(s *VersionUpsert) {
		s.SetCurrentVersion(v)
	})
}
...
// AddCurrentVersion adds v to the "CurrentVersion" field.
func (u *VersionUpsertBulk) AddCurrentVersion(v float64) *VersionUpsertBulk {
	return u.Update(func(s *VersionUpsert) {
		s.AddCurrentVersion(v)
	})
}
