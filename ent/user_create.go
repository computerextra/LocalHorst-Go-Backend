...
func (uc *UserCreate) SetMitarbeiterID(id int) *UserCreate {
	uc.mutation.SetMitarbeiterID(id)
	return uc
}

// SetNillableMitarbeiterID sets the "mitarbeiter" edge to the Mitarbeiter entity by ID if the given value is not nil.
func (uc *UserCreate) SetNillableMitarbeiterID(id *int) *UserCreate {
	if id != nil {
		uc = uc.SetMitarbeiterID(*id)
	}
	return uc
}

// SetMitarbeiter sets the "mitarbeiter" edge to the Mitarbeiter entity.
func (uc *UserCreate) SetMitarbeiter(m *Mitarbeiter) *UserCreate {
	return uc.SetMitarbeiterID(m.ID)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.MitarbeiterIDs(); len(nodes) > 0 {
